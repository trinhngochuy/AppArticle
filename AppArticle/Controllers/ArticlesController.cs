...
/*            return View(db.Articles.ToList());*/
        ...
        public ActionResult Create([Bind(Include = "id,title,description,thumnail,content,created_at")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,title,description,thumnail,content,created_at")] Article article)
        {
            if (ModelState.IsValid)
            {
